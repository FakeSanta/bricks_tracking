...
<head>
  ...
  <title>Bricks Tracking | Inscription</title>
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form method="POST">
                  ...
                  <button type="submit" name="register" class="btn btn-primary w-100 py-8 fs-4 mb-4">S'inscrire</button>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Déjà un compte ?</p>
                    <a class="text-primary fw-bold ms-2" href="./authentication-login.php">Se connecter</a>
                  </div>
                </form>
              </div>
            </div>
...
<?php
  if (isset($_POST['register'])) {
    ...
    register($_POST['name'], $hash_password, $_POST['mail']);
  }
